        ...
        <div className="container">
          <div className="row shadow p-3 pt-5 pb-5">
            <div className="col-lg-6">
              ...
              <p className="pt-3">
                <img className="img-fluid" src={location_b} /> &nbsp; ward
                no.6/A,Near DAV School, VFS Market,office no 60,Adipur
              ...
              <p >
                <img className="img-fluid" src={location_b} /> &nbsp; Office
                No.404 , Anand Mangal -3 Opp. Core House , Behind Parimal Garden
                Ahmedabad - 380006
              </p>

              <p>
                <a href="tel:+919099459608">
                  <img className="img-fluid" src={phone_call} />
                  &nbsp; +91 90994 59608
                </a>
              </p>
