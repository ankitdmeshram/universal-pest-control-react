...
const BirdsControl = () => {
  return (
    <>
      ...
      <Helmet>
        <title>Birds Control - Universal Pest Control</title>
        <meta charset="utf-8" />
        ...
        <meta property="og:title" content="Birds Control - Universal Pest Control" />
        <meta
        ...
        <meta
          name="twitter:title"
          content="Birds Control - Universal Pest Control"
        />
        <meta
        ...
        <meta
          name="keywords"
          content="Universal Pest Control, Birds control, Pest control service, pest control, best pest control, pest control in india, best pest control in india"
        />
